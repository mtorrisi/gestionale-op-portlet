...
import it.bysoftware.ct.model.WKRigoDocumentoModel;
import it.bysoftware.ct.model.WKRigoDocumentoSoap;
...
/**
 * The base model implementation for the WKRigoDocumento service. Represents a row in the &quot;WK_SSRIGORD&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link it.bysoftware.ct.model.WKRigoDocumentoModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link WKRigoDocumentoImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see WKRigoDocumentoImpl
 * @see it.bysoftware.ct.model.WKRigoDocumento
 * @see it.bysoftware.ct.model.WKRigoDocumentoModel
 * @generated
 */
@JSON(strict = true)
public class WKRigoDocumentoModelImpl extends BaseModelImpl<WKRigoDocumento>
	implements WKRigoDocumentoModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a w k rigo documento model instance should use the {@link it.bysoftware.ct.model.WKRigoDocumento} interface instead.
	 */
	public static final String TABLE_NAME = "WK_SSRIGORD";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.it.bysoftware.ct.model.WKRigoDocumento"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.it.bysoftware.ct.model.WKRigoDocumento"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.column.bitmask.enabled.it.bysoftware.ct.model.WKRigoDocumento"),
			true);
	 ...
	 */
	public static WKRigoDocumento toModel(WKRigoDocumentoSoap soapModel) {
		if (soapModel == null) {
			return null;
		}

		WKRigoDocumento model = new WKRigoDocumentoImpl();
	 ...
	 */
	public static List<WKRigoDocumento> toModels(
		WKRigoDocumentoSoap[] soapModels) {
		if (soapModels == null) {
			return null;
		}

		List<WKRigoDocumento> models = new ArrayList<WKRigoDocumento>(soapModels.length);

		for (WKRigoDocumentoSoap soapModel : soapModels) {
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.it.bysoftware.ct.model.WKRigoDocumento"));

	public WKRigoDocumentoModelImpl() {
	}
	...
	public WKRigoDocumento toEscapedModel() {
		if (_escapedModel == null) {
			_escapedModel = (WKRigoDocumento)ProxyUtil.newProxyInstance(_classLoader,
	...
	public Object clone() {
		...
		wkRigoDocumentoImpl.setAnno(getAnno());
		wkRigoDocumentoImpl.setNumeroOrdine(getNumeroOrdine());
		wkRigoDocumentoImpl.setRigoOrdine(getRigoOrdine());
		wkRigoDocumentoImpl.setCodiceVariante(getCodiceVariante());
		wkRigoDocumentoImpl.setDescrizioneVariante(getDescrizioneVariante());
		wkRigoDocumentoImpl.setCodiceArticolo(getCodiceArticolo());
		wkRigoDocumentoImpl.setDescrizione(getDescrizione());
		wkRigoDocumentoImpl.setUnitaMisura(getUnitaMisura());
		wkRigoDocumentoImpl.setColli(getColli());
		wkRigoDocumentoImpl.setPesoLordo(getPesoLordo());
		wkRigoDocumentoImpl.setTara(getTara());
		wkRigoDocumentoImpl.setPesoNetto(getPesoNetto());
		wkRigoDocumentoImpl.setPrezzo(getPrezzo());
		wkRigoDocumentoImpl.setPedane(getPedane());
		wkRigoDocumentoImpl.setNote(getNote());
		wkRigoDocumentoImpl.setTotalePesata(getTotalePesata());
		wkRigoDocumentoImpl.setImballo(getImballo());
		wkRigoDocumentoImpl.setGestioneReti(getGestioneReti());
		wkRigoDocumentoImpl.setRtxCl(getRtxCl());
		wkRigoDocumentoImpl.setKgRete(getKgRete());
		...
		wkRigoDocumentoImpl.setTipoDocumento(getTipoDocumento());
		wkRigoDocumentoImpl.setIdAssociato(getIdAssociato());
		wkRigoDocumentoImpl.setVerificato(getVerificato());
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof WKRigoDocumento)) {
			return false;
		}

		WKRigoDocumento wkRigoDocumento = (WKRigoDocumento)obj;
	...
	public void resetOriginalValues() {
		WKRigoDocumentoModelImpl wkRigoDocumentoModelImpl = this;

		wkRigoDocumentoModelImpl._originalAnno = wkRigoDocumentoModelImpl._anno;

		wkRigoDocumentoModelImpl._setOriginalAnno = false;

		wkRigoDocumentoModelImpl._originalNumeroOrdine = wkRigoDocumentoModelImpl._numeroOrdine;

		wkRigoDocumentoModelImpl._setOriginalNumeroOrdine = false;

		wkRigoDocumentoModelImpl._originalTipoDocumento = wkRigoDocumentoModelImpl._tipoDocumento;

		wkRigoDocumentoModelImpl._originalIdAssociato = wkRigoDocumentoModelImpl._idAssociato;

		wkRigoDocumentoModelImpl._setOriginalIdAssociato = false;

		wkRigoDocumentoModelImpl._columnBitmask = 0;
	}

	@Override
	public CacheModel<WKRigoDocumento> toCacheModel() {
		WKRigoDocumentoCacheModel wkRigoDocumentoCacheModel = new WKRigoDocumentoCacheModel();

		wkRigoDocumentoCacheModel.anno = getAnno();

		wkRigoDocumentoCacheModel.numeroOrdine = getNumeroOrdine();

		wkRigoDocumentoCacheModel.rigoOrdine = getRigoOrdine();

		wkRigoDocumentoCacheModel.codiceVariante = getCodiceVariante();

		String codiceVariante = wkRigoDocumentoCacheModel.codiceVariante;

		if ((codiceVariante != null) && (codiceVariante.length() == 0)) {
			wkRigoDocumentoCacheModel.codiceVariante = null;
		}

		wkRigoDocumentoCacheModel.descrizioneVariante = getDescrizioneVariante();

		String descrizioneVariante = wkRigoDocumentoCacheModel.descrizioneVariante;

		if ((descrizioneVariante != null) &&
				(descrizioneVariante.length() == 0)) {
			wkRigoDocumentoCacheModel.descrizioneVariante = null;
		}

		wkRigoDocumentoCacheModel.codiceArticolo = getCodiceArticolo();

		String codiceArticolo = wkRigoDocumentoCacheModel.codiceArticolo;

		if ((codiceArticolo != null) && (codiceArticolo.length() == 0)) {
			wkRigoDocumentoCacheModel.codiceArticolo = null;
		}

		wkRigoDocumentoCacheModel.descrizione = getDescrizione();

		String descrizione = wkRigoDocumentoCacheModel.descrizione;

		if ((descrizione != null) && (descrizione.length() == 0)) {
			wkRigoDocumentoCacheModel.descrizione = null;
		}

		wkRigoDocumentoCacheModel.unitaMisura = getUnitaMisura();

		String unitaMisura = wkRigoDocumentoCacheModel.unitaMisura;

		if ((unitaMisura != null) && (unitaMisura.length() == 0)) {
			wkRigoDocumentoCacheModel.unitaMisura = null;
		}

		wkRigoDocumentoCacheModel.colli = getColli();

		wkRigoDocumentoCacheModel.pesoLordo = getPesoLordo();

		wkRigoDocumentoCacheModel.tara = getTara();

		wkRigoDocumentoCacheModel.pesoNetto = getPesoNetto();

		wkRigoDocumentoCacheModel.prezzo = getPrezzo();

		wkRigoDocumentoCacheModel.pedane = getPedane();

		wkRigoDocumentoCacheModel.note = getNote();

		String note = wkRigoDocumentoCacheModel.note;

		if ((note != null) && (note.length() == 0)) {
			wkRigoDocumentoCacheModel.note = null;
		}

		wkRigoDocumentoCacheModel.totalePesata = getTotalePesata();

		wkRigoDocumentoCacheModel.imballo = getImballo();

		String imballo = wkRigoDocumentoCacheModel.imballo;

		if ((imballo != null) && (imballo.length() == 0)) {
			wkRigoDocumentoCacheModel.imballo = null;
		}

		wkRigoDocumentoCacheModel.gestioneReti = getGestioneReti();

		wkRigoDocumentoCacheModel.RtxCl = getRtxCl();

		wkRigoDocumentoCacheModel.kgRete = getKgRete();

		wkRigoDocumentoCacheModel.lotto = getLotto();

		String lotto = wkRigoDocumentoCacheModel.lotto;

		if ((lotto != null) && (lotto.length() == 0)) {
			wkRigoDocumentoCacheModel.lotto = null;
		}

		wkRigoDocumentoCacheModel.passaporto = getPassaporto();

		String passaporto = wkRigoDocumentoCacheModel.passaporto;

		if ((passaporto != null) && (passaporto.length() == 0)) {
			wkRigoDocumentoCacheModel.passaporto = null;
		}
		...
		wkRigoDocumentoCacheModel.sconto3 = getSconto3();

		wkRigoDocumentoCacheModel.tipoDocumento = getTipoDocumento();

		String tipoDocumento = wkRigoDocumentoCacheModel.tipoDocumento;

		if ((tipoDocumento != null) && (tipoDocumento.length() == 0)) {
			wkRigoDocumentoCacheModel.tipoDocumento = null;
		}

		wkRigoDocumentoCacheModel.idAssociato = getIdAssociato();

		wkRigoDocumentoCacheModel.verificato = getVerificato();

		return wkRigoDocumentoCacheModel;
	}
	...
	private static ClassLoader _classLoader = WKRigoDocumento.class.getClassLoader();
	private static Class<?>[] _escapedModelInterfaces = new Class[] {
			WKRigoDocumento.class
		};
	private int _anno;
	...
	private WKRigoDocumento _escapedModel;
}