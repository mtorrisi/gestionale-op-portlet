...
import it.bysoftware.ct.service.VettoriLocalService;
...
/**
 * Provides the base implementation for the vettori local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.bysoftware.ct.service.impl.VettoriLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class VettoriLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements VettoriLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.bysoftware.ct.service.VettoriLocalServiceUtil} to access the vettori local service.
	 */
	...
	@Override
	public Vettori addVettori(Vettori vettori) throws SystemException {
		vettori.setNew(true);

		return vettoriPersistence.update(vettori);
	}
	 ...
	 */
	@Override
	public Vettori createVettori(String codiceVettore) {
		return vettoriPersistence.create(codiceVettore);
	}
	...
	@Override
	public Vettori deleteVettori(String codiceVettore)
		throws PortalException, SystemException {
		return vettoriPersistence.remove(codiceVettore);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Vettori deleteVettori(Vettori vettori) throws SystemException {
		return vettoriPersistence.remove(vettori);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Vettori.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return vettoriPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return vettoriPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return vettoriPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return vettoriPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return vettoriPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Vettori fetchVettori(String codiceVettore) throws SystemException {
		return vettoriPersistence.fetchByPrimaryKey(codiceVettore);
	}
	 ...
	 */
	@Override
	public Vettori getVettori(String codiceVettore)
		throws PortalException, SystemException {
		return vettoriPersistence.findByPrimaryKey(codiceVettore);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return vettoriPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Vettori> getVettoris(int start, int end)
		throws SystemException {
		return vettoriPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getVettorisCount() throws SystemException {
		return vettoriPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Vettori updateVettori(Vettori vettori) throws SystemException {
		return vettoriPersistence.update(vettori);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.bysoftware.ct.model.Vettori",
			vettoriLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.bysoftware.ct.model.Vettori");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = vettoriPersistence.getDataSource();
	...
	private VettoriLocalServiceClpInvoker _clpInvoker = new VettoriLocalServiceClpInvoker();
}