...
import it.bysoftware.ct.service.CessioneCreditoLocalService;
...
/**
 * Provides the base implementation for the cessione credito local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.bysoftware.ct.service.impl.CessioneCreditoLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class CessioneCreditoLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CessioneCreditoLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.bysoftware.ct.service.CessioneCreditoLocalServiceUtil} to access the cessione credito local service.
	 */
	...
	@Override
	public CessioneCredito addCessioneCredito(CessioneCredito cessioneCredito)
		throws SystemException {
		cessioneCredito.setNew(true);

		return cessioneCreditoPersistence.update(cessioneCredito);
	}
	 ...
	 */
	@Override
	public CessioneCredito createCessioneCredito(long id) {
		return cessioneCreditoPersistence.create(id);
	}
	...
	@Override
	public CessioneCredito deleteCessioneCredito(long id)
		throws PortalException, SystemException {
		return cessioneCreditoPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CessioneCredito deleteCessioneCredito(
		CessioneCredito cessioneCredito) throws SystemException {
		return cessioneCreditoPersistence.remove(cessioneCredito);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CessioneCredito.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return cessioneCreditoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return cessioneCreditoPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CessioneCredito fetchCessioneCredito(long id)
		throws SystemException {
		return cessioneCreditoPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public CessioneCredito getCessioneCredito(long id)
		throws PortalException, SystemException {
		return cessioneCreditoPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return cessioneCreditoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CessioneCredito> getCessioneCreditos(int start, int end)
		throws SystemException {
		return cessioneCreditoPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getCessioneCreditosCount() throws SystemException {
		return cessioneCreditoPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CessioneCredito updateCessioneCredito(
		CessioneCredito cessioneCredito) throws SystemException {
		return cessioneCreditoPersistence.update(cessioneCredito);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.bysoftware.ct.model.CessioneCredito",
			cessioneCreditoLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = cessioneCreditoPersistence.getDataSource();
	...
	private CessioneCreditoLocalServiceClpInvoker _clpInvoker = new CessioneCreditoLocalServiceClpInvoker();
}