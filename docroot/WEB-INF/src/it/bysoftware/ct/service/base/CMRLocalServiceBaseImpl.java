...
import it.bysoftware.ct.service.CMRLocalService;
...
/**
 * Provides the base implementation for the c m r local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.bysoftware.ct.service.impl.CMRLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class CMRLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements CMRLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.bysoftware.ct.service.CMRLocalServiceUtil} to access the c m r local service.
	 */
	...
	@Override
	public CMR addCMR(CMR cmr) throws SystemException {
		cmr.setNew(true);

		return cmrPersistence.update(cmr);
	}
	 ...
	 */
	@Override
	public CMR createCMR(CMRPK cmrPK) {
		return cmrPersistence.create(cmrPK);
	}
	...
	@Override
	public CMR deleteCMR(CMRPK cmrPK) throws PortalException, SystemException {
		return cmrPersistence.remove(cmrPK);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CMR deleteCMR(CMR cmr) throws SystemException {
		return cmrPersistence.remove(cmr);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CMR.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return cmrPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return cmrPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return cmrPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return cmrPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public CMR fetchCMR(CMRPK cmrPK) throws SystemException {
		return cmrPersistence.fetchByPrimaryKey(cmrPK);
	}
	 ...
	 */
	@Override
	public CMR getCMR(CMRPK cmrPK) throws PortalException, SystemException {
		return cmrPersistence.findByPrimaryKey(cmrPK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return cmrPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CMR> getCMRs(int start, int end) throws SystemException {
		return cmrPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getCMRsCount() throws SystemException {
		return cmrPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CMR updateCMR(CMR cmr) throws SystemException {
		return cmrPersistence.update(cmr);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.bysoftware.ct.model.CMR",
			cmrLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.bysoftware.ct.model.CMR");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = cmrPersistence.getDataSource();
	...
	private CMRLocalServiceClpInvoker _clpInvoker = new CMRLocalServiceClpInvoker();
}