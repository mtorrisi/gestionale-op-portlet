...
import it.bysoftware.ct.service.ProgressivoLocalService;
...
/**
 * Provides the base implementation for the progressivo local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.bysoftware.ct.service.impl.ProgressivoLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ProgressivoLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ProgressivoLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.bysoftware.ct.service.ProgressivoLocalServiceUtil} to access the progressivo local service.
	 */
	...
	@Override
	public Progressivo addProgressivo(Progressivo progressivo)
		throws SystemException {
		progressivo.setNew(true);

		return progressivoPersistence.update(progressivo);
	}
	 ...
	 */
	@Override
	public Progressivo createProgressivo(ProgressivoPK progressivoPK) {
		return progressivoPersistence.create(progressivoPK);
	}
	...
	@Override
	public Progressivo deleteProgressivo(ProgressivoPK progressivoPK)
		throws PortalException, SystemException {
		return progressivoPersistence.remove(progressivoPK);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Progressivo deleteProgressivo(Progressivo progressivo)
		throws SystemException {
		return progressivoPersistence.remove(progressivo);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Progressivo.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return progressivoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return progressivoPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return progressivoPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public Progressivo fetchProgressivo(ProgressivoPK progressivoPK)
		throws SystemException {
		return progressivoPersistence.fetchByPrimaryKey(progressivoPK);
	}
	 ...
	 */
	@Override
	public Progressivo getProgressivo(ProgressivoPK progressivoPK)
		throws PortalException, SystemException {
		return progressivoPersistence.findByPrimaryKey(progressivoPK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return progressivoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Progressivo> getProgressivos(int start, int end)
		throws SystemException {
		return progressivoPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getProgressivosCount() throws SystemException {
		return progressivoPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Progressivo updateProgressivo(Progressivo progressivo)
		throws SystemException {
		return progressivoPersistence.update(progressivo);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.bysoftware.ct.model.Progressivo",
			progressivoLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = progressivoPersistence.getDataSource();
	...
	private ProgressivoLocalServiceClpInvoker _clpInvoker = new ProgressivoLocalServiceClpInvoker();
}