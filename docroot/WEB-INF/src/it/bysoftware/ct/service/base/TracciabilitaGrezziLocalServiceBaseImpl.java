...
import it.bysoftware.ct.service.TracciabilitaGrezziLocalService;
...
/**
 * Provides the base implementation for the tracciabilita grezzi local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.bysoftware.ct.service.impl.TracciabilitaGrezziLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class TracciabilitaGrezziLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TracciabilitaGrezziLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.bysoftware.ct.service.TracciabilitaGrezziLocalServiceUtil} to access the tracciabilita grezzi local service.
	 */
	...
	@Override
	public TracciabilitaGrezzi addTracciabilitaGrezzi(
		TracciabilitaGrezzi tracciabilitaGrezzi) throws SystemException {
		tracciabilitaGrezzi.setNew(true);

		return tracciabilitaGrezziPersistence.update(tracciabilitaGrezzi);
	}
	 ...
	 */
	@Override
	public TracciabilitaGrezzi createTracciabilitaGrezzi(long id) {
		return tracciabilitaGrezziPersistence.create(id);
	}
	...
	@Override
	public TracciabilitaGrezzi deleteTracciabilitaGrezzi(long id)
		throws PortalException, SystemException {
		return tracciabilitaGrezziPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TracciabilitaGrezzi deleteTracciabilitaGrezzi(
		TracciabilitaGrezzi tracciabilitaGrezzi) throws SystemException {
		return tracciabilitaGrezziPersistence.remove(tracciabilitaGrezzi);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TracciabilitaGrezzi.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return tracciabilitaGrezziPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tracciabilitaGrezziPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TracciabilitaGrezzi fetchTracciabilitaGrezzi(long id)
		throws SystemException {
		return tracciabilitaGrezziPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public TracciabilitaGrezzi getTracciabilitaGrezzi(long id)
		throws PortalException, SystemException {
		return tracciabilitaGrezziPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tracciabilitaGrezziPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TracciabilitaGrezzi> getTracciabilitaGrezzis(int start, int end)
		throws SystemException {
		return tracciabilitaGrezziPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTracciabilitaGrezzisCount() throws SystemException {
		return tracciabilitaGrezziPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TracciabilitaGrezzi updateTracciabilitaGrezzi(
		TracciabilitaGrezzi tracciabilitaGrezzi) throws SystemException {
		return tracciabilitaGrezziPersistence.update(tracciabilitaGrezzi);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.bysoftware.ct.model.TracciabilitaGrezzi",
			tracciabilitaGrezziLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tracciabilitaGrezziPersistence.getDataSource();
	...
	private TracciabilitaGrezziLocalServiceClpInvoker _clpInvoker = new TracciabilitaGrezziLocalServiceClpInvoker();
}