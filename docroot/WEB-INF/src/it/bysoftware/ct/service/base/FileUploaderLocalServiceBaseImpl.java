...
import it.bysoftware.ct.service.FileUploaderLocalService;
...
/**
 * Provides the base implementation for the file uploader local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.bysoftware.ct.service.impl.FileUploaderLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class FileUploaderLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FileUploaderLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.bysoftware.ct.service.FileUploaderLocalServiceUtil} to access the file uploader local service.
	 */
	...
	@Override
	public FileUploader addFileUploader(FileUploader fileUploader)
		throws SystemException {
		fileUploader.setNew(true);

		return fileUploaderPersistence.update(fileUploader);
	}
	 ...
	 */
	@Override
	public FileUploader createFileUploader(long fid) {
		return fileUploaderPersistence.create(fid);
	}
	...
	@Override
	public FileUploader deleteFileUploader(long fid)
		throws PortalException, SystemException {
		return fileUploaderPersistence.remove(fid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FileUploader deleteFileUploader(FileUploader fileUploader)
		throws SystemException {
		return fileUploaderPersistence.remove(fileUploader);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FileUploader.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return fileUploaderPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return fileUploaderPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public FileUploader fetchFileUploader(long fid) throws SystemException {
		return fileUploaderPersistence.fetchByPrimaryKey(fid);
	}
	 ...
	 */
	@Override
	public FileUploader getFileUploader(long fid)
		throws PortalException, SystemException {
		return fileUploaderPersistence.findByPrimaryKey(fid);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return fileUploaderPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FileUploader> getFileUploaders(int start, int end)
		throws SystemException {
		return fileUploaderPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getFileUploadersCount() throws SystemException {
		return fileUploaderPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FileUploader updateFileUploader(FileUploader fileUploader)
		throws SystemException {
		return fileUploaderPersistence.update(fileUploader);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.bysoftware.ct.model.FileUploader",
			fileUploaderLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = fileUploaderPersistence.getDataSource();
	...
	private FileUploaderLocalServiceClpInvoker _clpInvoker = new FileUploaderLocalServiceClpInvoker();
}