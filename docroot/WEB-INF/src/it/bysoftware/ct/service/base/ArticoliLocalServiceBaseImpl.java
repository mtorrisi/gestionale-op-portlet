...
import it.bysoftware.ct.service.ArticoliLocalService;
...
/**
 * Provides the base implementation for the articoli local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.bysoftware.ct.service.impl.ArticoliLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ArticoliLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements ArticoliLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.bysoftware.ct.service.ArticoliLocalServiceUtil} to access the articoli local service.
	 */
	...
	@Override
	public Articoli addArticoli(Articoli articoli) throws SystemException {
		articoli.setNew(true);

		return articoliPersistence.update(articoli);
	}
	 ...
	 */
	@Override
	public Articoli createArticoli(String codiceArticolo) {
		return articoliPersistence.create(codiceArticolo);
	}
	...
	@Override
	public Articoli deleteArticoli(String codiceArticolo)
		throws PortalException, SystemException {
		return articoliPersistence.remove(codiceArticolo);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Articoli deleteArticoli(Articoli articoli) throws SystemException {
		return articoliPersistence.remove(articoli);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Articoli.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return articoliPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return articoliPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return articoliPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return articoliPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public Articoli fetchArticoli(String codiceArticolo)
		throws SystemException {
		return articoliPersistence.fetchByPrimaryKey(codiceArticolo);
	}
	 ...
	 */
	@Override
	public Articoli getArticoli(String codiceArticolo)
		throws PortalException, SystemException {
		return articoliPersistence.findByPrimaryKey(codiceArticolo);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return articoliPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Articoli> getArticolis(int start, int end)
		throws SystemException {
		return articoliPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getArticolisCount() throws SystemException {
		return articoliPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Articoli updateArticoli(Articoli articoli) throws SystemException {
		return articoliPersistence.update(articoli);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.bysoftware.ct.model.Articoli",
			articoliLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.bysoftware.ct.model.Articoli");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = articoliPersistence.getDataSource();
	...
	private ArticoliLocalServiceClpInvoker _clpInvoker = new ArticoliLocalServiceClpInvoker();
}