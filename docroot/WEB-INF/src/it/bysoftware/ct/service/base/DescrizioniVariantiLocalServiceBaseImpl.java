...
import it.bysoftware.ct.service.DescrizioniVariantiLocalService;
...
/**
 * Provides the base implementation for the descrizioni varianti local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.bysoftware.ct.service.impl.DescrizioniVariantiLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class DescrizioniVariantiLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DescrizioniVariantiLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.bysoftware.ct.service.DescrizioniVariantiLocalServiceUtil} to access the descrizioni varianti local service.
	 */
	...
	@Override
	public DescrizioniVarianti addDescrizioniVarianti(
		DescrizioniVarianti descrizioniVarianti) throws SystemException {
		descrizioniVarianti.setNew(true);

		return descrizioniVariantiPersistence.update(descrizioniVarianti);
	}
	 ...
	 */
	@Override
	public DescrizioniVarianti createDescrizioniVarianti(String codiceVariante) {
		return descrizioniVariantiPersistence.create(codiceVariante);
	}
	...
	@Override
	public DescrizioniVarianti deleteDescrizioniVarianti(String codiceVariante)
		throws PortalException, SystemException {
		return descrizioniVariantiPersistence.remove(codiceVariante);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DescrizioniVarianti deleteDescrizioniVarianti(
		DescrizioniVarianti descrizioniVarianti) throws SystemException {
		return descrizioniVariantiPersistence.remove(descrizioniVarianti);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DescrizioniVarianti.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return descrizioniVariantiPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return descrizioniVariantiPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public DescrizioniVarianti fetchDescrizioniVarianti(String codiceVariante)
		throws SystemException {
		return descrizioniVariantiPersistence.fetchByPrimaryKey(codiceVariante);
	}
	 ...
	 */
	@Override
	public DescrizioniVarianti getDescrizioniVarianti(String codiceVariante)
		throws PortalException, SystemException {
		return descrizioniVariantiPersistence.findByPrimaryKey(codiceVariante);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return descrizioniVariantiPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DescrizioniVarianti> getDescrizioniVariantis(int start, int end)
		throws SystemException {
		return descrizioniVariantiPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getDescrizioniVariantisCount() throws SystemException {
		return descrizioniVariantiPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DescrizioniVarianti updateDescrizioniVarianti(
		DescrizioniVarianti descrizioniVarianti) throws SystemException {
		return descrizioniVariantiPersistence.update(descrizioniVarianti);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.bysoftware.ct.model.DescrizioniVarianti",
			descrizioniVariantiLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = descrizioniVariantiPersistence.getDataSource();
	...
	private DescrizioniVariantiLocalServiceClpInvoker _clpInvoker = new DescrizioniVariantiLocalServiceClpInvoker();
}