...
import it.bysoftware.ct.service.IvaLocalService;
...
/**
 * Provides the base implementation for the iva local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.bysoftware.ct.service.impl.IvaLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class IvaLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements IvaLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.bysoftware.ct.service.IvaLocalServiceUtil} to access the iva local service.
	 */
	...
	@Override
	public Iva addIva(Iva iva) throws SystemException {
		iva.setNew(true);

		return ivaPersistence.update(iva);
	}
	 ...
	 */
	@Override
	public Iva createIva(String codiceIva) {
		return ivaPersistence.create(codiceIva);
	}
	...
	@Override
	public Iva deleteIva(String codiceIva)
		throws PortalException, SystemException {
		return ivaPersistence.remove(codiceIva);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Iva deleteIva(Iva iva) throws SystemException {
		return ivaPersistence.remove(iva);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Iva.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return ivaPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return ivaPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return ivaPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return ivaPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Iva fetchIva(String codiceIva) throws SystemException {
		return ivaPersistence.fetchByPrimaryKey(codiceIva);
	}
	 ...
	 */
	@Override
	public Iva getIva(String codiceIva) throws PortalException, SystemException {
		return ivaPersistence.findByPrimaryKey(codiceIva);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return ivaPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Iva> getIvas(int start, int end) throws SystemException {
		return ivaPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getIvasCount() throws SystemException {
		return ivaPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Iva updateIva(Iva iva) throws SystemException {
		return ivaPersistence.update(iva);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.bysoftware.ct.model.Iva",
			ivaLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.bysoftware.ct.model.Iva");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = ivaPersistence.getDataSource();
	...
	private IvaLocalServiceClpInvoker _clpInvoker = new IvaLocalServiceClpInvoker();
}