...
/**
 * Provides the base implementation for the associato local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.bysoftware.ct.service.impl.AssociatoLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class AssociatoLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements AssociatoLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.bysoftware.ct.service.AssociatoLocalServiceUtil} to access the associato local service.
	 */
	...
	@Override
	public Associato addAssociato(Associato associato)
		throws SystemException {
		associato.setNew(true);

		return associatoPersistence.update(associato);
	}
	 ...
	 */
	@Override
	public Associato createAssociato(long id) {
		return associatoPersistence.create(id);
	}
	...
	@Override
	public Associato deleteAssociato(long id)
		throws PortalException, SystemException {
		return associatoPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Associato deleteAssociato(Associato associato)
		throws SystemException {
		return associatoPersistence.remove(associato);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Associato.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return associatoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return associatoPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return associatoPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public Associato fetchAssociato(long id) throws SystemException {
		return associatoPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public Associato getAssociato(long id)
		throws PortalException, SystemException {
		return associatoPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return associatoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Associato> getAssociatos(int start, int end)
		throws SystemException {
		return associatoPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getAssociatosCount() throws SystemException {
		return associatoPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Associato updateAssociato(Associato associato)
		throws SystemException {
		return associatoPersistence.update(associato);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.bysoftware.ct.model.Associato",
			associatoLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = associatoPersistence.getDataSource();
	...
	private AssociatoLocalServiceClpInvoker _clpInvoker = new AssociatoLocalServiceClpInvoker();
}