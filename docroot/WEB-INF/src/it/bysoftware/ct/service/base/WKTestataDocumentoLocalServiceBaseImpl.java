...
import it.bysoftware.ct.service.WKTestataDocumentoLocalService;
...
/**
 * Provides the base implementation for the w k testata documento local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.bysoftware.ct.service.impl.WKTestataDocumentoLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class WKTestataDocumentoLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements WKTestataDocumentoLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.bysoftware.ct.service.WKTestataDocumentoLocalServiceUtil} to access the w k testata documento local service.
	 */
	...
	@Override
	public WKTestataDocumento addWKTestataDocumento(
		WKTestataDocumento wkTestataDocumento) throws SystemException {
		wkTestataDocumento.setNew(true);

		return wkTestataDocumentoPersistence.update(wkTestataDocumento);
	}
	 ...
	 */
	@Override
	public WKTestataDocumento createWKTestataDocumento(
		WKTestataDocumentoPK wkTestataDocumentoPK) {
		return wkTestataDocumentoPersistence.create(wkTestataDocumentoPK);
	}
	...
	@Override
	public WKTestataDocumento deleteWKTestataDocumento(
		WKTestataDocumentoPK wkTestataDocumentoPK)
		throws PortalException, SystemException {
		return wkTestataDocumentoPersistence.remove(wkTestataDocumentoPK);
	}
	...
	public WKTestataDocumento deleteWKTestataDocumento(
		WKTestataDocumento wkTestataDocumento) throws SystemException {
		return wkTestataDocumentoPersistence.remove(wkTestataDocumento);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(WKTestataDocumento.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return wkTestataDocumentoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return wkTestataDocumentoPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public WKTestataDocumento fetchWKTestataDocumento(
		WKTestataDocumentoPK wkTestataDocumentoPK) throws SystemException {
		return wkTestataDocumentoPersistence.fetchByPrimaryKey(wkTestataDocumentoPK);
	}
	 ...
	 */
	@Override
	public WKTestataDocumento getWKTestataDocumento(
		WKTestataDocumentoPK wkTestataDocumentoPK)
		throws PortalException, SystemException {
		return wkTestataDocumentoPersistence.findByPrimaryKey(wkTestataDocumentoPK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return wkTestataDocumentoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<WKTestataDocumento> getWKTestataDocumentos(int start, int end)
		throws SystemException {
		return wkTestataDocumentoPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getWKTestataDocumentosCount() throws SystemException {
		return wkTestataDocumentoPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public WKTestataDocumento updateWKTestataDocumento(
		WKTestataDocumento wkTestataDocumento) throws SystemException {
		return wkTestataDocumentoPersistence.update(wkTestataDocumento);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.bysoftware.ct.model.WKTestataDocumento",
			wkTestataDocumentoLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = wkTestataDocumentoPersistence.getDataSource();
	...
	private WKTestataDocumentoLocalServiceClpInvoker _clpInvoker = new WKTestataDocumentoLocalServiceClpInvoker();
}