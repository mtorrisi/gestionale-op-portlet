...
import it.bysoftware.ct.service.PortoLocalService;
...
/**
 * Provides the base implementation for the porto local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.bysoftware.ct.service.impl.PortoLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class PortoLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements PortoLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.bysoftware.ct.service.PortoLocalServiceUtil} to access the porto local service.
	 */
	...
	@Override
	public Porto addPorto(Porto porto) throws SystemException {
		porto.setNew(true);

		return portoPersistence.update(porto);
	}
	 ...
	 */
	@Override
	public Porto createPorto(String codicePorto) {
		return portoPersistence.create(codicePorto);
	}
	...
	@Override
	public Porto deletePorto(String codicePorto)
		throws PortalException, SystemException {
		return portoPersistence.remove(codicePorto);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Porto deletePorto(Porto porto) throws SystemException {
		return portoPersistence.remove(porto);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Porto.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return portoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return portoPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return portoPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return portoPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Porto fetchPorto(String codicePorto) throws SystemException {
		return portoPersistence.fetchByPrimaryKey(codicePorto);
	}
	 ...
	 */
	@Override
	public Porto getPorto(String codicePorto)
		throws PortalException, SystemException {
		return portoPersistence.findByPrimaryKey(codicePorto);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return portoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Porto> getPortos(int start, int end) throws SystemException {
		return portoPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getPortosCount() throws SystemException {
		return portoPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Porto updatePorto(Porto porto) throws SystemException {
		return portoPersistence.update(porto);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.bysoftware.ct.model.Porto",
			portoLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.bysoftware.ct.model.Porto");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = portoPersistence.getDataSource();
	...
	private PortoLocalServiceClpInvoker _clpInvoker = new PortoLocalServiceClpInvoker();
}