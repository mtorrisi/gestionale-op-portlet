...
import it.bysoftware.ct.service.VociIvaLocalService;
...
/**
 * Provides the base implementation for the voci iva local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.bysoftware.ct.service.impl.VociIvaLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class VociIvaLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements VociIvaLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.bysoftware.ct.service.VociIvaLocalServiceUtil} to access the voci iva local service.
	 */
	...
	@Override
	public VociIva addVociIva(VociIva vociIva) throws SystemException {
		vociIva.setNew(true);

		return vociIvaPersistence.update(vociIva);
	}
	 ...
	 */
	@Override
	public VociIva createVociIva(String codiceIva) {
		return vociIvaPersistence.create(codiceIva);
	}
	...
	@Override
	public VociIva deleteVociIva(String codiceIva)
		throws PortalException, SystemException {
		return vociIvaPersistence.remove(codiceIva);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VociIva deleteVociIva(VociIva vociIva) throws SystemException {
		return vociIvaPersistence.remove(vociIva);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VociIva.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return vociIvaPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return vociIvaPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return vociIvaPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return vociIvaPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return vociIvaPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public VociIva fetchVociIva(String codiceIva) throws SystemException {
		return vociIvaPersistence.fetchByPrimaryKey(codiceIva);
	}
	 ...
	 */
	@Override
	public VociIva getVociIva(String codiceIva)
		throws PortalException, SystemException {
		return vociIvaPersistence.findByPrimaryKey(codiceIva);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return vociIvaPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VociIva> getVociIvas(int start, int end)
		throws SystemException {
		return vociIvaPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getVociIvasCount() throws SystemException {
		return vociIvaPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VociIva updateVociIva(VociIva vociIva) throws SystemException {
		return vociIvaPersistence.update(vociIva);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.bysoftware.ct.model.VociIva",
			vociIvaLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.bysoftware.ct.model.VociIva");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = vociIvaPersistence.getDataSource();
	...
	private VociIvaLocalServiceClpInvoker _clpInvoker = new VociIvaLocalServiceClpInvoker();
}