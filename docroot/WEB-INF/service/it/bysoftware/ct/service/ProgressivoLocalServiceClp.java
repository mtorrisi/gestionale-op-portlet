 ...
 * @generated
 */
public class ProgressivoLocalServiceClp implements ProgressivoLocalService {
	public ProgressivoLocalServiceClp(
		...
		_methodName19 = "getByAnnoIdAssociatoTipoDocumento";
	...
	public it.bysoftware.ct.model.Progressivo addProgressivo(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(progressivo) });
		}
		catch (Throwable t) {
		...
		return (it.bysoftware.ct.model.Progressivo)ClpSerializer.translateOutput(returnObj);
	}
	...
	public it.bysoftware.ct.model.Progressivo createProgressivo(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					...
					new Object[] { ClpSerializer.translateInput(progressivoPK) });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<it.bysoftware.ct.model.Progressivo> getProgressivos(
		...
		return (java.util.List<it.bysoftware.ct.model.Progressivo>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<it.bysoftware.ct.model.Progressivo> getByAnnoIdAssociatoTipoDocumento(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName19,
					...
					new Object[] { anno, idAssociato, tipoDocumento });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
