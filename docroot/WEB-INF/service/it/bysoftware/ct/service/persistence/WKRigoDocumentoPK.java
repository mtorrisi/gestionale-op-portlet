 ...
 * @generated
 */
public class WKRigoDocumentoPK implements Comparable<WKRigoDocumentoPK>,
	Serializable {
	public int anno;
	...
	public WKRigoDocumentoPK() {
	}

	public WKRigoDocumentoPK(int anno, long numeroOrdine, int rigoOrdine,
	...
	@Override
	public int compareTo(WKRigoDocumentoPK pk) {
		if (pk == null) {
			return -1;
		}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof WKRigoDocumentoPK)) {
			return false;
		}

		WKRigoDocumentoPK pk = (WKRigoDocumentoPK)obj;
	...
	public int hashCode() {
		...
		String.valueOf(rigoOrdine) + String.valueOf(tipoDocumento) +
