...
/**
 * The persistence utility for the file uploader service. This utility wraps {@link FileUploaderPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see FileUploaderPersistenceImpl
 * @generated
 */
public class FileUploaderUtil {
	 ...
	 */
	public static void clearCache(FileUploader fileUploader) {
		getPersistence().clearCache(fileUploader);
	}
	 ...
	 */
	public static List<FileUploader> findWithDynamicQuery(
	 ...
	 */
	public static FileUploader update(FileUploader fileUploader)
		throws SystemException {
		return getPersistence().update(fileUploader);
	}
	...
	public static FileUploader update(FileUploader fileUploader,
		...
		return getPersistence().update(fileUploader, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(fileUploader);
	}
	...
	*/
	public static void cacheResult(
		java.util.List<it.bysoftware.ct.model.FileUploader> fileUploaders) {
		getPersistence().cacheResult(fileUploaders);
	}
	...
	*/
	public static it.bysoftware.ct.model.FileUploader create(long fid) {
	...
	*/
	public static it.bysoftware.ct.model.FileUploader remove(long fid)
		throws com.liferay.portal.kernel.exception.SystemException,
			it.bysoftware.ct.NoSuchFileUploaderException {
		return getPersistence().remove(fid);
	}

	public static it.bysoftware.ct.model.FileUploader updateImpl(
		it.bysoftware.ct.model.FileUploader fileUploader)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(fileUploader);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.bysoftware.ct.model.FileUploader findByPrimaryKey(long fid)
		throws com.liferay.portal.kernel.exception.SystemException,
			it.bysoftware.ct.NoSuchFileUploaderException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.bysoftware.ct.model.FileUploader fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<it.bysoftware.ct.model.FileUploader> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static FileUploaderPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (FileUploaderPersistence)PortletBeanLocatorUtil.locate(it.bysoftware.ct.service.ClpSerializer.getServletContextName(),
					FileUploaderPersistence.class.getName());

			ReferenceRegistry.registerReference(FileUploaderUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(FileUploaderPersistence persistence) {
	}

	private static FileUploaderPersistence _persistence;
}