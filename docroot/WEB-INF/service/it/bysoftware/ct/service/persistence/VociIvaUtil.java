...
/**
 * The persistence utility for the voci iva service. This utility wraps {@link VociIvaPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class VociIvaUtil {
	 ...
	 */
	public static void clearCache(VociIva vociIva) {
		getPersistence().clearCache(vociIva);
	}
	 ...
	 */
	public static List<VociIva> findWithDynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
	 ...
	 */
	public static List<VociIva> findWithDynamicQuery(
	 ...
	 */
	public static VociIva update(VociIva vociIva) throws SystemException {
		return getPersistence().update(vociIva);
	}

	/**
	 * @see com.liferay.portal.service.persistence.BasePersistence#update(com.liferay.portal.model.BaseModel, ServiceContext)
	 */
	public static VociIva update(VociIva vociIva, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(vociIva, serviceContext);
	}
	...
	*/
	public static void cacheResult(it.bysoftware.ct.model.VociIva vociIva) {
		getPersistence().cacheResult(vociIva);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(vociIvas);
	}
	...
	*/
	public static it.bysoftware.ct.model.VociIva create(
	...
	*/
	public static it.bysoftware.ct.model.VociIva remove(
		java.lang.String codiceIva)
	...
	public static it.bysoftware.ct.model.VociIva updateImpl(
		it.bysoftware.ct.model.VociIva vociIva)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(vociIva);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.bysoftware.ct.model.VociIva findByPrimaryKey(
		java.lang.String codiceIva)
		throws com.liferay.portal.kernel.exception.SystemException,
			it.bysoftware.ct.NoSuchVociIvaException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.bysoftware.ct.model.VociIva fetchByPrimaryKey(
		java.lang.String codiceIva)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<it.bysoftware.ct.model.VociIva> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static VociIvaPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (VociIvaPersistence)PortletBeanLocatorUtil.locate(it.bysoftware.ct.service.ClpSerializer.getServletContextName(),
					VociIvaPersistence.class.getName());

			ReferenceRegistry.registerReference(VociIvaUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(VociIvaPersistence persistence) {
	}

	private static VociIvaPersistence _persistence;
}