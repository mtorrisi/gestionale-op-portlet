...
/**
 * The persistence utility for the anagrafica associato o p service. This utility wraps {@link AnagraficaAssociatoOPPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class AnagraficaAssociatoOPUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(AnagraficaAssociatoOP anagraficaAssociatoOP) {
		getPersistence().clearCache(anagraficaAssociatoOP);
	}
	 ...
	 */
	public static List<AnagraficaAssociatoOP> findWithDynamicQuery(
	 ...
	 */
	public static AnagraficaAssociatoOP update(
		AnagraficaAssociatoOP anagraficaAssociatoOP) throws SystemException {
		return getPersistence().update(anagraficaAssociatoOP);
	}
	...
	public static AnagraficaAssociatoOP update(
		...
		return getPersistence().update(anagraficaAssociatoOP, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(anagraficaAssociatoOP);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(anagraficaAssociatoOPs);
	}
	...
	*/
	public static it.bysoftware.ct.model.AnagraficaAssociatoOP create(
		it.bysoftware.ct.service.persistence.AnagraficaAssociatoOPPK anagraficaAssociatoOPPK) {
		return getPersistence().create(anagraficaAssociatoOPPK);
	}
	...
	*/
	public static it.bysoftware.ct.model.AnagraficaAssociatoOP remove(
		it.bysoftware.ct.service.persistence.AnagraficaAssociatoOPPK anagraficaAssociatoOPPK)
		throws com.liferay.portal.kernel.exception.SystemException,
			it.bysoftware.ct.NoSuchAnagraficaAssociatoOPException {
		return getPersistence().remove(anagraficaAssociatoOPPK);
	}

	public static it.bysoftware.ct.model.AnagraficaAssociatoOP updateImpl(
		it.bysoftware.ct.model.AnagraficaAssociatoOP anagraficaAssociatoOP)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(anagraficaAssociatoOP);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.bysoftware.ct.model.AnagraficaAssociatoOP findByPrimaryKey(
		it.bysoftware.ct.service.persistence.AnagraficaAssociatoOPPK anagraficaAssociatoOPPK)
		throws com.liferay.portal.kernel.exception.SystemException,
			it.bysoftware.ct.NoSuchAnagraficaAssociatoOPException {
		return getPersistence().findByPrimaryKey(anagraficaAssociatoOPPK);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.bysoftware.ct.model.AnagraficaAssociatoOP fetchByPrimaryKey(
		it.bysoftware.ct.service.persistence.AnagraficaAssociatoOPPK anagraficaAssociatoOPPK)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(anagraficaAssociatoOPPK);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<it.bysoftware.ct.model.AnagraficaAssociatoOP> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static AnagraficaAssociatoOPPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (AnagraficaAssociatoOPPersistence)PortletBeanLocatorUtil.locate(it.bysoftware.ct.service.ClpSerializer.getServletContextName(),
					AnagraficaAssociatoOPPersistence.class.getName());

			ReferenceRegistry.registerReference(AnagraficaAssociatoOPUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(AnagraficaAssociatoOPPersistence persistence) {
	}

	private static AnagraficaAssociatoOPPersistence _persistence;
}