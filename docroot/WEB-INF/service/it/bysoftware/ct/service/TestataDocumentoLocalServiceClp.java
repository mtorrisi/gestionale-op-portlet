 ...
 * @generated
 */
public class TestataDocumentoLocalServiceClp
	implements TestataDocumentoLocalService {
	public TestataDocumentoLocalServiceClp(
	...
	public it.bysoftware.ct.model.TestataDocumento addTestataDocumento(
		...
		return (it.bysoftware.ct.model.TestataDocumento)ClpSerializer.translateOutput(returnObj);
	}
	...
	public it.bysoftware.ct.model.TestataDocumento createTestataDocumento(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					...
					new Object[] {
						ClpSerializer.translateInput(testataDocumentoPK)
					});
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
