 ...
 * @generated
 */
public class CausaleTrasportoLocalServiceClp
	implements CausaleTrasportoLocalService {
	public CausaleTrasportoLocalServiceClp(
	...
	public it.bysoftware.ct.model.CausaleTrasporto addCausaleTrasporto(
		...
		return (it.bysoftware.ct.model.CausaleTrasporto)ClpSerializer.translateOutput(returnObj);
	}
	...
	public it.bysoftware.ct.model.CausaleTrasporto createCausaleTrasporto(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					...
					new Object[] {
						ClpSerializer.translateInput(codiceCausaleTrasporto)
					});
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<it.bysoftware.ct.model.CausaleTrasporto> getCausaleTrasportos(
		...
		return (java.util.List<it.bysoftware.ct.model.CausaleTrasporto>)ClpSerializer.translateOutput(returnObj);
	}
