...
/**
 * Provides the local service interface for Anagrafica. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AnagraficaLocalServiceUtil
...
public interface AnagraficaLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AnagraficaLocalServiceUtil} to access the anagrafica local service. Add custom service methods to {@link it.bysoftware.ct.service.impl.AnagraficaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
