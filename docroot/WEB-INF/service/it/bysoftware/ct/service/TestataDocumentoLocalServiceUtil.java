...
/**
 * Provides the local service utility for TestataDocumento. This utility wraps
 * {@link it.bysoftware.ct.service.impl.TestataDocumentoLocalServiceImpl} and is the
 ...
 * @generated
 */
public class TestataDocumentoLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link it.bysoftware.ct.service.impl.TestataDocumentoLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static it.bysoftware.ct.model.TestataDocumento addTestataDocumento(
		it.bysoftware.ct.model.TestataDocumento testataDocumento)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addTestataDocumento(testataDocumento);
	}
	...
	*/
	public static it.bysoftware.ct.model.TestataDocumento createTestataDocumento(
		it.bysoftware.ct.service.persistence.TestataDocumentoPK testataDocumentoPK) {
		return getService().createTestataDocumento(testataDocumentoPK);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.bysoftware.ct.model.TestataDocumento deleteTestataDocumento(
		it.bysoftware.ct.service.persistence.TestataDocumentoPK testataDocumentoPK)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteTestataDocumento(testataDocumentoPK);
	}
	...
	*/
	public static it.bysoftware.ct.model.TestataDocumento deleteTestataDocumento(
		it.bysoftware.ct.model.TestataDocumento testataDocumento)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteTestataDocumento(testataDocumento);
	}
	...
	*/
	...
	public static it.bysoftware.ct.model.TestataDocumento fetchTestataDocumento(
		it.bysoftware.ct.service.persistence.TestataDocumentoPK testataDocumentoPK)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchTestataDocumento(testataDocumentoPK);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.bysoftware.ct.model.TestataDocumento getTestataDocumento(
		it.bysoftware.ct.service.persistence.TestataDocumentoPK testataDocumentoPK)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getTestataDocumento(testataDocumentoPK);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<it.bysoftware.ct.model.TestataDocumento> getTestataDocumentos(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getTestataDocumentos(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getTestataDocumentosCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getTestataDocumentosCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.bysoftware.ct.model.TestataDocumento updateTestataDocumento(
		it.bysoftware.ct.model.TestataDocumento testataDocumento)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateTestataDocumento(testataDocumento);
	}
	...
	*/
	...
	public static TestataDocumentoLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					TestataDocumentoLocalService.class.getName());

			if (invokableLocalService instanceof TestataDocumentoLocalService) {
				_service = (TestataDocumentoLocalService)invokableLocalService;
			}
			else {
				_service = new TestataDocumentoLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(TestataDocumentoLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(TestataDocumentoLocalService service) {
	}

	private static TestataDocumentoLocalService _service;
}