 ...
 * @generated
 */
public class DescrizioniVariantiLocalServiceClp
	implements DescrizioniVariantiLocalService {
	public DescrizioniVariantiLocalServiceClp(
	...
	public it.bysoftware.ct.model.DescrizioniVarianti addDescrizioniVarianti(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(descrizioniVarianti)
					});
		}
		catch (Throwable t) {
		...
		return (it.bysoftware.ct.model.DescrizioniVarianti)ClpSerializer.translateOutput(returnObj);
	}
	...
	public it.bysoftware.ct.model.DescrizioniVarianti createDescrizioniVarianti(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					...
					new Object[] { ClpSerializer.translateInput(codiceVariante) });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<it.bysoftware.ct.model.DescrizioniVarianti> getDescrizioniVariantis(
		...
		return (java.util.List<it.bysoftware.ct.model.DescrizioniVarianti>)ClpSerializer.translateOutput(returnObj);
	}
