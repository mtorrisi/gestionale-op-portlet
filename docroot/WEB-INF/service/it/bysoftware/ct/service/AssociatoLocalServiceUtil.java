...
/**
 * Provides the local service utility for Associato. This utility wraps
 * {@link it.bysoftware.ct.service.impl.AssociatoLocalServiceImpl} and is the
 ...
 * @see it.bysoftware.ct.service.impl.AssociatoLocalServiceImpl
 * @generated
 */
public class AssociatoLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link it.bysoftware.ct.service.impl.AssociatoLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static it.bysoftware.ct.model.Associato addAssociato(
		it.bysoftware.ct.model.Associato associato)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addAssociato(associato);
	}
	...
	*/
	public static it.bysoftware.ct.model.Associato createAssociato(long id) {
		return getService().createAssociato(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.bysoftware.ct.model.Associato deleteAssociato(long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteAssociato(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.bysoftware.ct.model.Associato deleteAssociato(
		it.bysoftware.ct.model.Associato associato)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteAssociato(associato);
	}
	...
	*/
	...
	public static it.bysoftware.ct.model.Associato fetchAssociato(long id)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchAssociato(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.bysoftware.ct.model.Associato getAssociato(long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getAssociato(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<it.bysoftware.ct.model.Associato> getAssociatos(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getAssociatos(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getAssociatosCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getAssociatosCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.bysoftware.ct.model.Associato updateAssociato(
		it.bysoftware.ct.model.Associato associato)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateAssociato(associato);
	}
	...
	*/
	...
	public static AssociatoLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					AssociatoLocalService.class.getName());

			if (invokableLocalService instanceof AssociatoLocalService) {
				_service = (AssociatoLocalService)invokableLocalService;
			}
			else {
				_service = new AssociatoLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(AssociatoLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(AssociatoLocalService service) {
	}

	private static AssociatoLocalService _service;
}