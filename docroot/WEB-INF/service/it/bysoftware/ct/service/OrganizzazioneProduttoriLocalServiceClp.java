 ...
 * @generated
 */
public class OrganizzazioneProduttoriLocalServiceClp
	implements OrganizzazioneProduttoriLocalService {
	public OrganizzazioneProduttoriLocalServiceClp(
	...
	public it.bysoftware.ct.model.OrganizzazioneProduttori addOrganizzazioneProduttori(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(organizzazioneProduttori)
					});
		}
		catch (Throwable t) {
		...
		return (it.bysoftware.ct.model.OrganizzazioneProduttori)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<it.bysoftware.ct.model.OrganizzazioneProduttori> getOrganizzazioneProduttoris(
		...
		return (java.util.List<it.bysoftware.ct.model.OrganizzazioneProduttori>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public it.bysoftware.ct.model.OrganizzazioneProduttori getOP(long id)
		...
		try {
			...
			if (t instanceof it.bysoftware.ct.NoSuchOrganizzazioneProduttoriException) {
				throw (it.bysoftware.ct.NoSuchOrganizzazioneProduttoriException)t;
			}
