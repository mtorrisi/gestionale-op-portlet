 ...
 * @generated
 */
public class ClientiDatiAggLocalServiceClp implements ClientiDatiAggLocalService {
	public ClientiDatiAggLocalServiceClp(
		...
		_methodName19 = "getDatiAggByCodiceAnagrafica";
	...
	public it.bysoftware.ct.model.ClientiDatiAgg addClientiDatiAgg(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(clientiDatiAgg) });
		}
		catch (Throwable t) {
		...
		return (it.bysoftware.ct.model.ClientiDatiAgg)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<it.bysoftware.ct.model.ClientiDatiAgg> getClientiDatiAggs(
		...
		return (java.util.List<it.bysoftware.ct.model.ClientiDatiAgg>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public it.bysoftware.ct.model.ClientiDatiAgg getDatiAggByCodiceAnagrafica(
		...
		try {
			...
			if (t instanceof it.bysoftware.ct.NoSuchClientiDatiAggException) {
				throw (it.bysoftware.ct.NoSuchClientiDatiAggException)t;
			}
