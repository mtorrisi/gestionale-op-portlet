...
/**
 * Provides the local service interface for ArticoliAssociatoOP. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ArticoliAssociatoOPLocalServiceUtil
...
public interface ArticoliAssociatoOPLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ArticoliAssociatoOPLocalServiceUtil} to access the articoli associato o p local service. Add custom service methods to {@link it.bysoftware.ct.service.impl.ArticoliAssociatoOPLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
