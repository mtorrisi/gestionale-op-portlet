...
/**
 * Provides the local service utility for CMR. This utility wraps
 * {@link it.bysoftware.ct.service.impl.CMRLocalServiceImpl} and is the
 ...
 * @see it.bysoftware.ct.service.impl.CMRLocalServiceImpl
 * @generated
 */
public class CMRLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link it.bysoftware.ct.service.impl.CMRLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static it.bysoftware.ct.model.CMR addCMR(
		it.bysoftware.ct.model.CMR cmr)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addCMR(cmr);
	}
	...
	*/
	public static it.bysoftware.ct.model.CMR createCMR(
		it.bysoftware.ct.service.persistence.CMRPK cmrPK) {
		return getService().createCMR(cmrPK);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.bysoftware.ct.model.CMR deleteCMR(
		it.bysoftware.ct.service.persistence.CMRPK cmrPK)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteCMR(cmrPK);
	}
	...
	*/
	public static it.bysoftware.ct.model.CMR deleteCMR(
		it.bysoftware.ct.model.CMR cmr)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteCMR(cmr);
	}
	...
	*/
	...
	public static it.bysoftware.ct.model.CMR fetchCMR(
		it.bysoftware.ct.service.persistence.CMRPK cmrPK)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchCMR(cmrPK);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.bysoftware.ct.model.CMR getCMR(
		it.bysoftware.ct.service.persistence.CMRPK cmrPK)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getCMR(cmrPK);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<it.bysoftware.ct.model.CMR> getCMRs(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getCMRs(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getCMRsCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getCMRsCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.bysoftware.ct.model.CMR updateCMR(
		it.bysoftware.ct.model.CMR cmr)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateCMR(cmr);
	}
	...
	*/
	...
	public static CMRLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					CMRLocalService.class.getName());

			if (invokableLocalService instanceof CMRLocalService) {
				_service = (CMRLocalService)invokableLocalService;
			}
			else {
				_service = new CMRLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(CMRLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(CMRLocalService service) {
	}

	private static CMRLocalService _service;
}