 ...
 * @generated
 */
public class CMRLocalServiceClp implements CMRLocalService {
	public CMRLocalServiceClp(InvokableLocalService invokableLocalService) {
	...
	public it.bysoftware.ct.model.CMR addCMR(it.bysoftware.ct.model.CMR cmr)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(cmr) });
		}
		catch (Throwable t) {
	...
	public it.bysoftware.ct.model.CMR createCMR(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					...
					new Object[] { ClpSerializer.translateInput(cmrPK) });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
