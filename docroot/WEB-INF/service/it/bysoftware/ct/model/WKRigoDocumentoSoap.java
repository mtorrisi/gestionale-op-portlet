...
/**
 * This class is used by SOAP remote services, specifically {@link it.bysoftware.ct.service.http.WKRigoDocumentoServiceSoap}.
 *
 * @author Brian Wing Shun Chan
 * @see it.bysoftware.ct.service.http.WKRigoDocumentoServiceSoap
 * @generated
 */
public class WKRigoDocumentoSoap implements Serializable {
	public static WKRigoDocumentoSoap toSoapModel(WKRigoDocumento model) {
		WKRigoDocumentoSoap soapModel = new WKRigoDocumentoSoap();
		...
		soapModel.setVerificato(model.getVerificato());

		return soapModel;
	}

	public static WKRigoDocumentoSoap[] toSoapModels(WKRigoDocumento[] models) {
		WKRigoDocumentoSoap[] soapModels = new WKRigoDocumentoSoap[models.length];
	...
	public static WKRigoDocumentoSoap[][] toSoapModels(
		WKRigoDocumento[][] models) {
		WKRigoDocumentoSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new WKRigoDocumentoSoap[models.length][models[0].length];
		}
		else {
			soapModels = new WKRigoDocumentoSoap[0][0];
		}
	...
	public static WKRigoDocumentoSoap[] toSoapModels(
		List<WKRigoDocumento> models) {
		List<WKRigoDocumentoSoap> soapModels = new ArrayList<WKRigoDocumentoSoap>(models.size());

		for (WKRigoDocumento model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new WKRigoDocumentoSoap[soapModels.size()]);
	}

	public WKRigoDocumentoSoap() {
	}
	...
	public void setPrimaryKey(WKRigoDocumentoPK pk) {
		setAnno(pk.anno);
