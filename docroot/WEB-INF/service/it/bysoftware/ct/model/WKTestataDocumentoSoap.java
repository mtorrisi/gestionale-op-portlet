...
/**
 * This class is used by SOAP remote services, specifically {@link it.bysoftware.ct.service.http.WKTestataDocumentoServiceSoap}.
 *
 * @author Brian Wing Shun Chan
 * @see it.bysoftware.ct.service.http.WKTestataDocumentoServiceSoap
 * @generated
 */
public class WKTestataDocumentoSoap implements Serializable {
	public static WKTestataDocumentoSoap toSoapModel(WKTestataDocumento model) {
		WKTestataDocumentoSoap soapModel = new WKTestataDocumentoSoap();
	...
	public static WKTestataDocumentoSoap[] toSoapModels(
		WKTestataDocumento[] models) {
		WKTestataDocumentoSoap[] soapModels = new WKTestataDocumentoSoap[models.length];
	...
	public static WKTestataDocumentoSoap[][] toSoapModels(
		WKTestataDocumento[][] models) {
		WKTestataDocumentoSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new WKTestataDocumentoSoap[models.length][models[0].length];
		}
		else {
			soapModels = new WKTestataDocumentoSoap[0][0];
		}
	...
	public static WKTestataDocumentoSoap[] toSoapModels(
		List<WKTestataDocumento> models) {
		List<WKTestataDocumentoSoap> soapModels = new ArrayList<WKTestataDocumentoSoap>(models.size());

		for (WKTestataDocumento model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new WKTestataDocumentoSoap[soapModels.size()]);
	}

	public WKTestataDocumentoSoap() {
	}
	...
	public void setPrimaryKey(WKTestataDocumentoPK pk) {
		setAnno(pk.anno);
