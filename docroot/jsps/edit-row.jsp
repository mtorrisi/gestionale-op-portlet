...
<form action="${saveWKRigoDocumento}" class="form-horizontal" id="registra-associato" method="post">
	<fieldset>
		<aui:field-wrapper >
		...
		<liferay-ui:error key="noValidCode" message="Codice articolo non valido" />
	   	<aui:layout>
		   	<aui:column columnWidth="50" first="true">
				<input class="form-control input-md" id="codiceAssociato" name="<portlet:namespace />codiceAssociato" placeholder="" style="display: none"  type="text" value="<%= r.getCodiceArticolo() %>" />
