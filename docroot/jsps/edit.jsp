...
<aui:field-wrapper >
    <div class="btn-toolbar">
        <div class="btn-group">
            ...
            <button id="btnTrace"   class="btn" disabled="true"><i class="icon-list-alt" ></i>Scheda Tracciabilit‡†</button>
        </div>
    </div>  
</aui:field-wrapper>
...
//                                            console.log("1: " + Y.one('#<portlet:namespace/>recProt').val());
                                                ...
                                                alert("Attenzione, non Ë stato possibile invare la mail di notifica.\n");
                                                break;
                                            case 5:
                                                alert("Attenzione, il numero di protocollo: " + data.id + " Ë gi‡† presente in archivio.\n");
                                                break;
                                            case 6:
